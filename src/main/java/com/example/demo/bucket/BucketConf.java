 ...
 * template). Convention alignée sur EmailConf: le bucket est lu depuis la propriété
 * "aws.s3.bucket" (mappée en test via src/test/java/.../conf/BucketConf#configureProperties, déjà
 * présent dans ton repo).
 */
@PojaGenerated
@Configuration
